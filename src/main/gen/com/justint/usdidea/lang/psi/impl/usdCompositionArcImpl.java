...
public class usdCompositionArcImpl extends ASTWrapperPsiElement implements usdCompositionArc {

  public usdCompositionArcImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull usdVisitor visitor) {
    visitor.visitCompositionArc(this);
  }
