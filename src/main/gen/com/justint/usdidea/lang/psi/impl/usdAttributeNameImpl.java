...
public class usdAttributeNameImpl extends ASTWrapperPsiElement implements usdAttributeName {

  public usdAttributeNameImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @Nullable
  public usdNamespacedIdentifier getNamespacedIdentifier() {
    return findChildByClass(usdNamespacedIdentifier.class);
  }
