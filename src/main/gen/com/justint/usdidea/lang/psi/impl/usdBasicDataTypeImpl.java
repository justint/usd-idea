...
public class usdBasicDataTypeImpl extends ASTWrapperPsiElement implements usdBasicDataType {

  public usdBasicDataTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull usdVisitor visitor) {
    visitor.visitBasicDataType(this);
  }
