...
public class usdAttributeValueImpl extends ASTWrapperPsiElement implements usdAttributeValue {

  public usdAttributeValueImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public usdItem getItem() {
    return findNotNullChildByClass(usdItem.class);
  }
