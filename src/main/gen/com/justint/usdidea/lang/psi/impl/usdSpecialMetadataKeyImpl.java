...
public class usdSpecialMetadataKeyImpl extends ASTWrapperPsiElement implements usdSpecialMetadataKey {

  public usdSpecialMetadataKeyImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull usdVisitor visitor) {
    visitor.visitSpecialMetadataKey(this);
  }
