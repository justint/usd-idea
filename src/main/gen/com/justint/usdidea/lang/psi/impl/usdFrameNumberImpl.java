...
public class usdFrameNumberImpl extends ASTWrapperPsiElement implements usdFrameNumber {

  public usdFrameNumberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull usdVisitor visitor) {
    visitor.visitFrameNumber(this);
  }
