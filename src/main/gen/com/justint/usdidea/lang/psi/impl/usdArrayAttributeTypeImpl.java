...
public class usdArrayAttributeTypeImpl extends ASTWrapperPsiElement implements usdArrayAttributeType {

  public usdArrayAttributeTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull usdVisitor visitor) {
    visitor.visitArrayAttributeType(this);
  }
  ...
  public usdSingleAttributeType getSingleAttributeType() {
    return findNotNullChildByClass(usdSingleAttributeType.class);
  }
