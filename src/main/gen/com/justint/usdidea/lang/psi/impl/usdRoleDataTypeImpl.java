...
public class usdRoleDataTypeImpl extends ASTWrapperPsiElement implements usdRoleDataType {

  public usdRoleDataTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull usdVisitor visitor) {
    visitor.visitRoleDataType(this);
  }
